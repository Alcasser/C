...
if __name__ == "__main__":
    ...
    fh = open('./2017_09_26_13_22_04_albert.lopez.alcacer.enc', 'rb')
    bacyph = bytearray(fh.read())
    fh = open('./2017_09_26_13_22_04_albert.lopez.alcacer.key', 'rb')
    bakey = bytearray(fh.read())
    ...
    '''
    decr = moo.decrypt(bacyph, len(bacyph), moo.modeOfOperation["CBC"], bakey,
            moo.aes.keySize["SIZE_128"], iv)
